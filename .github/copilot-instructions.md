# 🤖 Copilot Central Router & Guardrails

Tu comportamiento, decisiones de código y flujos de trabajo están gobernados estrictamente por los protocolos centrales del repositorio 4geeks-fullstack-template.
...
- Queda rotundamente prohibido proponer o dar por hecho cambios en `ROADMAP.md`.
- Antes de cualquier simulación de pasos o actualización de tareas, debes presentar la propuesta en texto en el chat y esperar a que el usuario te dé su aprobación explícita.
